...
func templatesFunctionsYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/functions.yml", size: 24819, mode: os.FileMode(420), modTime: time.Unix(1526099550, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
