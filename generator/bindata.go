...
func templatesCommentGoTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/comment.go.tmpl", size: 741, mode: os.FileMode(420), modTime: time.Unix(1520654647, 0)}
...
func templatesVm_functionsGoTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/vm_functions.go.tmpl", size: 2560, mode: os.FileMode(420), modTime: time.Unix(1520657029, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
