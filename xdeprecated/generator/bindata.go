...
func templatesCommentGoTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/comment.go.tmpl", size: 741, mode: os.FileMode(420), modTime: time.Unix(1520968804, 0)}
...
func templatesDocsMdTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/docs.md.tmpl", size: 401, mode: os.FileMode(420), modTime: time.Unix(1520968804, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesVm_functionsGoTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/vm_functions.go.tmpl", size: 3054, mode: os.FileMode(420), modTime: time.Unix(1520968804, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
